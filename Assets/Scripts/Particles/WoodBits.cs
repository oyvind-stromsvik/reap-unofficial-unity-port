...
public class WoodBits : MonoBehaviour {
    ...
    void Start() {
        transform.position = new Vector3(transform.position.x + Random.Range(0, 17), transform.position.y - Random.Range(0, 17), 0);
        speed = new Vector3(Random.Range(-1f, 1f), Random.Range(0f, 2f), 0);

        spriteAnimator.fps = Random.Range(12, 21);
        spriteAnimator.Play("s_wood_bits");
